...
async function _(t, a = x()) {
  if (
    (a._routePreloaded || (a._routePreloaded = new Set()),
    a._routePreloaded.has(t))
  )
    return;
  const e = (a._preloadPromises = a._preloadPromises || []);
  if (e.length > 4) return Promise.all(e).then(() => _(t, a));
  a._routePreloaded.add(t);
  const r = a
    .resolve(t)
    .matched.map((o) => {
      var n;
      return (n = o.components) == null ? void 0 : n.default;
    })
    .filter((o) => typeof o == "function");
  for (const o of r) {
    const n = Promise.resolve(o())
      .catch(() => {})
      .finally(() => e.splice(e.indexOf(n)));
    e.push(n);
  }
  await Promise.all(e);
}
const B = (...t) => t.find((a) => a !== void 0),
  E = "noopener noreferrer";
function w(t) {
  ...
  return k({
    ...
    setup(e, { slots: r }) {
          ...
          S(() => {
            u = g(() => {
              ...
              (d = s == null ? void 0 : s.value) != null &&
                d.tagName &&
                (l = m.observe(s.value, async () => {
                  l == null || l(),
                    (l = null),
                    await Promise.all([
                      f.hooks
                        .callHook("link:prefetch", n.value)
                        .catch(() => {}),
                      !c.value && _(n.value, o).catch(() => {}),
                    ]),
                    (v.value = !0);
                }));
            });
      ...
      return () => {
        ...
        const i =
            typeof n.value == "object"
              ? ((m = o.resolve(n.value)) == null ? void 0 : m.href) ?? null
              : n.value || null,
          f = e.target || null,
          u = e.noRel
            ? null
            : B(e.rel, t.externalRelAttribute, i ? E : "") || null,
          l = () => T(i, { replace: e.replace });
        return e.custom
          ? r.default
            ? r.default({
                href: i,
...
const O = w({ componentName: "NuxtLink" });
function I() {
  const t = p();
    ...
    r = (n, c) => (
      a ||
        (a = new IntersectionObserver((v) => {
          for (const s of v) {
            const i = e.get(s.target);
            (s.isIntersecting || s.intersectionRatio > 0) && i && i();
          }
        })),
      e.set(n, c),
      a.observe(n),
      () => {
        e.delete(n),
          a.unobserve(n),
          e.size === 0 && (a.disconnect(), (a = null));
      }
    );
  return (t._observer = { observe: r });
}
function L() {
