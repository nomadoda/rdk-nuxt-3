  ...
  [39, 13],
  {
    ...
    281: function (t, n, e) {
      ...
      content.__esModule && (content = content.default),
        "string" == typeof content && (content = [[t.i, content, ""]]),
        content.locals && (t.exports = content.locals);
      (0, e(4).default)("6f43efa5", content, !0, { sourceMap: !1 });
    },
    348: function (t, n, e) {
      "use strict";
      e(281);
    ...
    349: function (t, n, e) {
      ...
      r.push([
        t.i,
        "/*purgecss start ignore*/\n.page-front[data-v-7854a3a6]{\n  margin-bottom:5rem;\n}\n.page-front h1[data-v-7854a3a6]{\n    font-size:2.25rem;\n    line-height:2.5rem;\n    font-weight:800;\n    --tw-text-opacity:1;\n    color:rgba(0, 0, 0, var(--tw-text-opacity))\n}\n.page-front .byline[data-v-7854a3a6]{\n    margin-top:2rem;\n    border-bottom-width:2px;\n    font-size:0.875rem;\n    line-height:1.25rem;\n    font-weight:700\n}\n.page-front .preamble[data-v-7854a3a6]{\n    margin-top:2rem;\n    font-size:1.25rem;\n    line-height:1.75rem;\n    font-weight:700;\n    line-height:2rem\n}\n.page-front section.sidebar-section[data-v-7854a3a6]{\n    margin:0px;\n    margin-bottom:2rem;\n}\n.page-front section.sidebar-section h2[data-v-7854a3a6]{\n      padding-top:1rem;\n      padding-bottom:1rem;\n      font-size:1.5rem;\n      line-height:2rem;\n      font-weight:700\n}\n.page-front section.sidebar-section .block[data-v-7854a3a6]{\n      overflow:hidden;\n      border-radius:0.375rem;\n}\n.page-front section.sidebar-section .block h2[data-v-7854a3a6]{\n        --tw-bg-opacity:1;\n        background-color:rgba(255, 255, 255, var(--tw-bg-opacity));\n        text-align:center\n}\n.page-front section.sidebar-section .block__content[data-v-7854a3a6]{\n        padding-left:1rem;\n        padding-right:1rem;\n        padding-top:1rem;\n        padding-bottom:1rem\n}\n.page-front section.sidebar-section.more .block[data-v-7854a3a6]{\n      background-color:#38AA83;\n}\n.page-front section.sidebar-section.more .block h2[data-v-7854a3a6]{\n        color:#38AA83\n}\n.page-front section.sidebar-section.more .block__content ul[data-v-7854a3a6]{\n          margin-bottom:1rem;\n}\n.page-front section.sidebar-section.more .block__content ul li[data-v-7854a3a6]{\n            margin-top:1rem;\n            text-align:center;\n}\n.page-front section.sidebar-section.more .block__content ul li a[data-v-7854a3a6]{\n              --tw-text-opacity:1;\n              color:rgba(255, 255, 255, var(--tw-text-opacity))\n}\n.page-front section.sidebar-section.more .block__content ul li a[data-v-7854a3a6]:hover{\n              opacity:.7\n}\n\n/*purgecss end ignore*/",
        "",
      ]),
        (r.locals = {}),
        (t.exports = r);
            ...
            return ((n = function* () {
              var n,
                ...
                article =
                  o ||
                  (yield e(
                    "vego/tips/".concat(r.parent, "/").concat(r.slug)
                  ).fetch()),
                c = yield e("vego/tips/".concat(r.parent, "/index"))
                  .only(["title", "dir", "path"])
                  .fetch()
                  .catch(() => {}),
                l = yield e("vego/tips/".concat(r.parent))
                  .limit(20)
                  .only(["title", "dir", "path"])
                  .fetch()
                  .catch(() => []);
              ...
              meta: [
                {
                  ...
                  property: "og:url",
                  content:
                    "https://www.raddadjuren.se/vego/tips" +
                    "".concat(
