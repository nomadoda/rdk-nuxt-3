...
class _ extends Array {
  constructor(i) {
    typeof i == "number" ? super(i) : (super(...(i || [])), De(this));
  }
}
function V(e = []) {
  const i = [];
        ...
        o !== void 0 &&
          ...
          (H(i[l]) && H(s[l])
            ? s[l].__swiper__
              ...
              : I(i[l], s[l])
            : !H(i[l]) && H(s[l])
            ? ((i[l] = {}), s[l].__swiper__ ? (i[l] = s[l]) : I(i[l], s[l]))
            : (i[l] = s[l]));
      }
    }
  }
...
function $t({ swiper: e, on: i, emit: t }) {
  const n = P();
  let s = null,
    r = null;
  const a = () => {
...
function Bt({ swiper: e, extendParams: i, on: t, emit: n }) {
  const s = [],
    r = P(),
    a = (o, u = {}) => {
      ...
      if (n.slidesPerView === "auto") {
        ...
        if (
          ...
          if (ne && ne === "border-box") x = ee + te + ie;
            ...
            const { clientWidth: Le, offsetWidth: $e } = E[0];
            x = ee + Oe + Pe + te + ie + ($e - Le);
          }
        }
...
function Ci() {
  ...
  p && t && e.changeDirection(), I(e.params, o);
...
const $i = { addClasses: Pi, removeClasses: Li };
function Bi(e, i, t, n, s, r) {
  const a = P();
  let d;
  function l() {
    r && r();
...
const zi = { loadImage: Bi, preloadImages: Ii };
function Ai() {
  const e = this,
  ...
  Wi = {
    ...
    setup(e, i) {
      ...
      if (
        ((v.onAny = function (O) {
          for (
            var x = arguments.length, N = new Array(x > 1 ? x - 1 : 0), b = 1;
            b < x;
            b++
          )
            N[b - 1] = arguments[b];
        ...
        D(f.value.params.virtual, O), D(f.value.originalParams.virtual, O);
      }
      fe(() => {
        !o.value && f.value && (f.value.emitSlidesClasses(), (o.value = !0));
        const { passedParams: O } = ue(e, !1),
          x = Gi(O, c.value, p.value, m.value, (N) => N.props && N.props.key);
        (c.value = O),
          (x.length || l.value) &&
            f.value &&
            !f.value.destroyed &&
...
export { h as $, Wi as S, qi as a, Fi as c };
