  ...
  [46],
  {
    372: function (e, t) {
      function n(e, t, n, r, o, l, h) {
        ...
        d.done ? t(c) : Promise.resolve(c).then(r, o);
      }
      var r = function (e) {
        var t =
      ...
      e.exports = class {
            ...
            ? ((n =
                "object" == typeof e
                  ...
                  : {
                      query: {
                        type: "bool",
                        should: this.options.fullTextSearchFields.map((t) => ({
                          type: "match",
                          field: t,
                          value: e,
                          prefix_length: 1,
              ...
              (this.query = this.query.find({ $fts: n }).sortByScoring()),
              this)
            : this;
          var n;
        }
        surround(e) {
          var { before: t = 1, after: n = 1 } =
              arguments.length > 1 && void 0 !== arguments[1]
                ? arguments[1]
                : {},
            r = 0 === e.indexOf("/") ? "path" : "slug";
          this.onlyKeys && this.onlyKeys.push(r),
            this.withoutKeys &&
              (this.withoutKeys = this.withoutKeys.filter((e) => e !== r));
          return (
            this.postprocess.push((data) => {
              var o = data.findIndex((t) => t[r] === e),
                l = new Array(t + n).fill(null, 0);
              if (-1 === o) return l;
              for (
                var h = data.slice(o - t, o),
                  d = data.slice(o + 1, o + 1 + n),
                  c = 0,
                  i = t - 1;
                i >= 0;
                i--
                ...
                (l[i] = h[c] || null), c++;
              for (var f = 0, _ = t; _ <= n; _++) (l[_] = d[f] || null), f++;
              return l;
            }),
            this
          );
        ...
        limit(e) {
          return (
            "string" == typeof e && (e = parseInt(e)), (this.limitN = e), this
          );
        }
        skip(e) {
          return (
            "string" == typeof e && (e = parseInt(e)), (this.skipN = e), this
          );
        }
        fetch() {
          var e,
          ...
          return ((e = function* () {
            t.sortKeys &&
              t.sortKeys.length &&
              (t.query = t.query.compoundsort(t.sortKeys)),
              t.skipN && (t.query = t.query.offset(t.skipN)),
              t.limitN && (t.query = t.query.limit(t.limitN));
            var data = t.query.data({ removeMeta: !0 });
            for (var e of (t.onlyKeys &&
              (t.options.watch && t.onlyKeys.push("path", "extension"),
              t.postprocess.unshift((data) =>
                data.map((e) =>
                  (function (e) {
                    var t =
                      arguments.length > 1 && void 0 !== arguments[1]
            ...
            t.withoutKeys &&
              (t.options.watch &&
                (t.withoutKeys = t.withoutKeys.filter(
                  (e) => !["path", "extension"].includes(e)
                )),
              t.postprocess.unshift((data) =>
                data.map((e) => r(e, t.withoutKeys))
              )),
            t.postprocess))
              data = e(data);
            if (!data) throw new Error("".concat(t.path, " not found"));
            ...
            function (e, t, n) {
              ...
              class v {
                ...
                find(e, t = !1) {
                  ...
                  !this._filterInitialized &&
                    ...
                    m[h] &&
                    (d = !0);
                  const c = f.a[this._collection._defaultLokiOperatorPackage],
                  ...
                  if (!d) {
                    for (let i = 0; i < data.length; i++)
                      if (c[h](data[i][r], l) && (_.push(i), t)) return this;
                    return this;
                  }
                  ...
                  if (this._collection._cloneObjects || t) {
                    ...
                    for (let i = 0; i < d.length; i++)
                      (o = this._collection._defineNestedProperties(
                        ...
                        r && (delete o.$loki, delete o.meta),
                        h.push(o);
                  } else for (let i = 0; i < d.length; i++) h.push(data[d[i]]);
                  return h;
                }
                update(e) {
                  this._filterInitialized ||
                ...
                eqJoin(e, t, n, r, o) {
                  let l,
                    ...
                    m = this.data(o),
                    y = m.length;
                  if (e instanceof C) d = e.chain().data(o);
                  else if (e instanceof v) d = e.data(o);
                  else {
                    if (!Array.isArray(e))
                      throw new TypeError(
                  ...
                  l = d.length;
                  for (let i = 0; i < l; i++)
                    (h = _ ? n(d[i]) : d[i][n]), (w[h] = d[i]);
                  r || (r = (e, t) => ({ left: e, right: t }));
                  for (let e = 0; e < y; e++)
                    (h = f ? t(m[e]) : m[e][t]), c.push(r(m[e], w[h] || {}));
                  return (
                    (this._collection = new C("joinData")),
                    this._collection.insert(c),
                    (this._filteredRows = []),
                    (this._filterInitialized = !1),
                    this
                  );
              ...
              class C extends r.a {
                ...
                insert(e) {
                  ...
                  return (
                    this.emit("insert", n),
                    (n = this._cloneObjects ? c(n, this._cloneMethod) : n),
                    1 === n.length ? n[0] : n
                  );
                }
                insertOne(e, t = !1) {
                  ...
                  const o = this._defineNestedProperties(
                    this._cloneObjects ? c(e, this._cloneMethod) : e
                  );
                  if (
                    (this._disableMeta ||
                      void 0 !== o.meta ||
                    ...
                    return (
                      ...
                      (n = this._cloneObjects ? c(o, this._cloneMethod) : o),
                ...
                update(e) {
                  if (Array.isArray(e))
                    ...
                    try {
                      ...
                      let l = o;
                      this._cloneObjects && (l = c(o, this._cloneMethod)),
                ...
                _add(e) {
                  ...
                  try {
                    ...
                    return (
                      ...
                      this.commit(),
                      (this._dirty = !0),
                      this._cloneObjects ? c(t, this._cloneMethod) : t
                    );
                  } catch (e) {
                    throw (this.rollback(), this.emit("error", e), e);
                  }
                ...
                by(e, t) {
                  ...
                  return this._cloneObjects
                    ? c(this._lokimap[n], this._cloneMethod)
                    : this._lokimap[n];
                }
                findOne(e) {
                  e = e || {};
            ...
            function (e, t, n) {
              ...
              class _ {
                ...
                score(e, t, n, r, o, l, h = 0) {
                  ...
                  const d = this._idf(e, h || n.df);
                  for (const [h, c] of n.dc)
                    o.has(h) || o.set(h, []),
                      !0 === r
                        ? o.get(h).push({
                            tf: c,
                    ...
                    for (let i = 0; i < l.length; i++) {
                      ...
                      if (void 0 !== n.tf) {
                        const t = n.tf,
                          ...
                          c = this._avgFieldLength(n.fieldName),
                          f = (t * (r + 1)) / (t + r * (1 - b + b * (l / c)));
                        (d = n.idf * f * n.boost),
                          o &&
                            h.push({
                              boost: n.boost,
                        ...
                        (d = n.boost),
                          o && h.push({ boost: n.boost, score: d });
                      t += d;
                    }
              ...
              const C = [new S(2)],
                ...
                z = [new S(553385984, 1431678474), new S(1431655765)];
              class M extends I {
                constructor(e) {
                ...
                transition(e, t, n) {
                  ...
                  if (t === this._w) {
                    ...
                    const e = 6 * n + r;
                    (o += I.unpack(z, e, 2)), (r = I.unpack(P, e, 3) - 1);
                  }
              ...
              class H {
                constructor(input, e) {
                  ...
                  t <= m &&
                    ...
                    this._numRanges++),
                    (this._description =
                      1 === e ? new M(input.length) : new Q(input.length));
                }
                toAutomaton() {
                  let e = new x();
                  ...
                  for (let r = 0; r < n; r++) {
                    ...
                    for (let t = 0; t < this._alphabet.length; t++) {
                      const l = this._alphabet[t],
                        ...
                        d = this._description.transition(r, n, h);
                      d >= 0 && e.addTransition(r, d, l, l);
                    }
              ...
              class Y {
                ...
                _recursive(e, t) {
                  ...
                  switch (
                    ...
                    case "term": {
                      const h = c(e.value);
                      let d = f.getTermIndex(h, l);
                      this._scorer.score(o, r, d, t, n, h);
                      break;
                    }
                    case "terms":
                    ...
                    case "fuzzy": {
                      const [h, d] = (function (e, t) {
                        ...
                        if (
                          (0 !== o &&
                            ((d = f.getTermIndex(_, d)), (m = m.slice(o))),
                          null === d)
                        )
                          return [h, v];
                        if (0 === m.length) {
                          if (l) {
                            const e = f.extendTermIndex(d);
                            for (let i = 0; i < e.length; i++)
                              h.push({
                                index: e[i].index,
                                term: e[i].term,
                      ...
                      if (
                        ("or" === (void 0 !== e.operator ? e.operator : "or")
                          ? (void 0 !== e.minimum_should_match &&
                              (c.minimum_should_match = e.minimum_should_match),
                            (c.should = f))
                          : (c.must = f),
                        (c.boost = r),
                        void 0 !== e.fuzziness)
    ...
    393: function (e, t, n) {
      ...
      var c,
        ...
        w = function () {
          ...
          Array.from(arguments).forEach((n) => {
            "string" == typeof n ? t.push(n) : "object" == typeof n && (e = n);
          });
          var { text: text = !1, deep: n = !1 } = e,
            path = "/".concat(t.join("/").replace(/\/+/g, "/")),
            r = !path || !!_.find((e) => e === path),
            l = r
              ? { dir: n ? { $regex: new RegExp("^".concat(path)) } : path }
              : { path: path },
            h = r ? [] : [(data) => data[0]];
          return new o.a(
            {
              query: f.chain().find(l, !r),
              path: path,
              postprocess: h,
              text: text,
            },
      ...
      t.default = (e) => (
        (c = new h.a("content.db")).loadJSONObject(e),
        (f = c.getCollection("items")),
        w
      );
    },
  },
