  ...
  [40, 13],
  {
    ...
    280: function (t, n, e) {
      ...
      content.__esModule && (content = content.default),
        "string" == typeof content && (content = [[t.i, content, ""]]),
        content.locals && (t.exports = content.locals);
      (0, e(4).default)("1b0472c2", content, !0, { sourceMap: !1 });
    },
    346: function (t, n, e) {
      "use strict";
      e(280);
    ...
    347: function (t, n, e) {
      ...
      r.push([
        t.i,
        "/*purgecss start ignore*/\n.page-front[data-v-1a590485]{\n  margin-bottom:5rem;\n}\n.page-front h1[data-v-1a590485]{\n    font-size:2.25rem;\n    line-height:2.5rem;\n    font-weight:800;\n    --tw-text-opacity:1;\n    color:rgba(0, 0, 0, var(--tw-text-opacity))\n}\n.page-front .byline[data-v-1a590485]{\n    margin-top:2rem;\n    border-bottom-width:2px;\n    font-size:0.875rem;\n    line-height:1.25rem;\n    font-weight:700\n}\n.page-front .preamble[data-v-1a590485]{\n    margin-top:2rem;\n    font-size:1.25rem;\n    line-height:1.75rem;\n    font-weight:700;\n    line-height:2rem\n}\n.page-front section.sidebar-section[data-v-1a590485]{\n    margin:0px;\n    margin-bottom:2rem;\n}\n.page-front section.sidebar-section h2[data-v-1a590485]{\n      padding-top:1rem;\n      padding-bottom:1rem;\n      font-size:1.5rem;\n      line-height:2rem;\n      font-weight:700\n}\n.page-front section.sidebar-section .block[data-v-1a590485]{\n      overflow:hidden;\n      border-radius:0.375rem;\n}\n.page-front section.sidebar-section .block h2[data-v-1a590485]{\n        --tw-bg-opacity:1;\n        background-color:rgba(255, 255, 255, var(--tw-bg-opacity));\n        text-align:center\n}\n.page-front section.sidebar-section .block__content[data-v-1a590485]{\n        padding-left:1rem;\n        padding-right:1rem;\n        padding-top:1rem;\n        padding-bottom:1rem\n}\n.page-front section.sidebar-section.more .block[data-v-1a590485]{\n      background-color:#38AA83;\n}\n.page-front section.sidebar-section.more .block h2[data-v-1a590485]{\n        color:#38AA83\n}\n.page-front section.sidebar-section.more .block__content ul[data-v-1a590485]{\n          margin-bottom:1rem;\n}\n.page-front section.sidebar-section.more .block__content ul li[data-v-1a590485]{\n            margin-top:1rem;\n            text-align:center;\n}\n.page-front section.sidebar-section.more .block__content ul li a[data-v-1a590485]{\n              --tw-text-opacity:1;\n              color:rgba(255, 255, 255, var(--tw-text-opacity))\n}\n.page-front section.sidebar-section.more .block__content ul li a[data-v-1a590485]:hover{\n              opacity:.7\n}\n\n/*purgecss end ignore*/",
        "",
      ]),
        (r.locals = {}),
        (t.exports = r);
    ...
    405: function (t, n, e) {
      ...
      var l = r.a.extend({
          asyncData(t) {
            return ((n = function* () {
              var { $content: n, params: e, payload: r } = t,
                o = r || (yield n("vego/tips/".concat(e.slug)).fetch()),
                c = yield n("vego/tips/".concat(e.slug, "/index"))
                  .only(["title", "dir", "path"])
                  .fetch()
                  .catch(() => {});
              return {
                article: c
                  ? yield n("vego/tips/".concat(e.slug, "/index"))
                      .fetch()
                      .catch(() => {})
                  : o,
                parent: c,
                moreArticles: c
                  ? yield n("vego/tips/".concat(e.slug))
                      .limit(20)
                      .only(["title", "path"])
                      .fetch()
                  : yield n("vego/tips")
          ...
          methods: { stripPageRoot: o.c, stripIndex: o.b },
        }),
        d = l,
        m = (e(346), e(2)),
                                ...
                                n(
                                  ...
                                  [
                                    n(
                                      ...
                                      {
                                        attrs: {
                                          to: t.stripIndex(t.article.path),
                                        },
                                      },
                                      [n("h2", [t._v(t._s(t.article.title))])]
                                    ),
                                    n(
                                      "div",
