...
function R(e, t) {
  ...
  for (let n = 0; n < o.length; n++) {
    let a = o[n],
      l = a.indexOf("=");
    if (l < 0) continue;
    let y = a.substr(0, l).trim(),
      u = a.substr(++l, a.length).trim();
    u[0] == '"' && (u = u.slice(1, -1)), r[y] == null && (r[y] = D(u, s));
  }
  return r;
}
function m(e, t, r) {
  ...
  let s = o(t);
  if (s && !c.test(s)) throw new TypeError("argument val is invalid");
  let n = e + "=" + s;
  if (i.maxAge != null) {
    let a = i.maxAge - 0;
...
const j = {
  path: "/",
  watch: !0,
  decode: (e) => A(decodeURIComponent(e)),
  encode: (e) =>
...
function O(e, t) {
  ...
  const r = { ...j, ...t },
    i = q(r) || {},
    o = S(i[e] ?? ((s = r.default) == null ? void 0 : s.call(r)));
  {
    const n = () => {
      I(e, o.value, r);
    };
    r.watch ? C(o, n, { deep: r.watch !== "shallow" }) : n();
  }
  return o;
}
function q(e = {}) {
...
function B(e, t, r = {}) {
  return t == null ? m(e, t, { ...r, maxAge: -1 }) : m(e, t, r);
}
function I(e, t, r = {}) {
  document.cookie = B(e, t, r);
}
const L = ["p", "h1", "h2", "h3", "h4", "h5", "h6", "li"];
function f(e, t) {
  return (
    e.type === t ||
...
function d(e) {
  return f(e, "text") || typeof e.children == "string";
}
function g(e) {
...
function p(e) {
  ...
  if (d(e)) return e.children || e.value;
  const t = g(e);
  return Array.isArray(t) ? t.map(p).join("") : "";
}
function h(e, t = ["p"]) {
  if (Array.isArray(e)) return e.flatMap((i) => h(i, t));
  let r = e;
  return (
    t.some((i) => i === "*" || f(e, i)) &&
      ((r = g(e) || e),
      !Array.isArray(r) && L.some((i) => f(e, i)) && (r = [r])),
    r
  );
}
function x(e, t = ["p"]) {
  return (
    ...
    t.length
      ? e
          .flatMap((r) => x(h(r, [t[0]]), t.slice(1)))
          .filter((r) => !(d(r) && p(r).trim() === ""))
      : e
  );
}
const N = (e) => T(e, w().public.content.api.baseURL),
  v = () => ({ unwrap: h, flatUnwrap: x }),
  z = () => {
    throw (
      (console.warn(
  ...
  P = () => {
    const { experimental: e } = w().content;
    if (e.clientDB) return !0;
    const t = b().query;
    return Object.prototype.hasOwnProperty.call(t, "preview") && !t.preview
      ? !1
      : !!(t.preview || O("previewToken").value);
  };
export { z as a, v as b, P as s, O as u, N as w };
